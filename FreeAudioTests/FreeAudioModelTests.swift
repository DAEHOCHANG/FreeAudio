...
class FreeAudioModelTests: XCTestCase {
    ...
    func test1and2() throws {
        manager.command(of: .init(editType: .trim)!)
    ...
    func test3() throws {
        ...
        manager.command(of: .init(editType: .trim)!)
        manager.command(of: .init(editType: .changeTrimTimeRange, TimeRange(start:0, end:10))!)
        manager.command(of: .init(editType: .changeTrimTimeRange, TimeRange(start:0, end:10))!)
        manager.command(of: .init(editType: .changeTrimTimeRange, TimeRange(start:0, end:10))!)
        manager.command(of: .init(editType: .changeTrimTimeRange, TimeRange(start:0, end:10))!)
        manager.command(of: .init(editType: .changeTrimTimeRange, TimeRange(start:0, end:10))!)
        manager.command(of: .init(editType: .changeMergeTimeRange, TimeRange(start:0, end:10))!)
        manager.command(of: .init(editType: .merge)!)
